...
st.write('---')
st.markdown(
    '\n<h3>Суть данного приложения - это определение уровня английского языка, необходимого для понимания '
    '50 - 70% фильма.',
    unsafe_allow_html=True
)
st.markdown(
    '\n<h3>Добавьте файл с субтитрами на английском языке в формате "srt" и получите уровень английского, '
    'необходимого для комфортного просмотра фильма на английском языке!</h3>',
    unsafe_allow_html=True
)
